...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($content)) {
        ...
        if (empty($error)) {
            ...
            $stmt = $conn->prepare("INSERT INTO review (`title`, `content`, `slug`, `status`, `image`) VALUES (?, ?, ?, ?, ?)");
                    ...
                    <form name="add_blog" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Content</label>
                                    <textarea name="content" class="form-control" placeholder="Review Content" required></textarea>
                                </div>
                            </div>
							<div class="col-md-12">
                                <div class="form-group">
